...
class ThreeDModelLoader {
  ...
  constructor(parent, field, params, setValue) {
    ...
    this.field.threeDModelLoader.preview = this.field.threeDModelLoader.preview || false;

    // IE11 can neither handle preview nor conversion
    this.canPreview = this.field.threeDModelLoader.preview && window.navigator.userAgent.indexOf('Trident/') === -1;
